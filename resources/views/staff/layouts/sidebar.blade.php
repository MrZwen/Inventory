<div id="sidebar" class="sidebar fixed top-0 left-0 bottom-0 w-[300px] bg-slate-900 text-center overflow-y-auto z-10 p-2">
    ...
    <!-- Users Link -->
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-800 text-white 
        {{ request()->is('users-staff') ? 'bg-blue-800' : '' }}">
        <i class="bi bi-people-fill text-white"></i>
        <a href="/users-staff" class="text-[15px] ml-4 text-gray-200">Users</a>
    </div>
