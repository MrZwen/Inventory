<div id="modal-{{ $item->id }}" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50  justify-center items-center w-full h-full">
    <div class="relative p-4 w-full max-w-lg bg-white rounded-lg shadow dark:bg-gray-800 max-h-full overflow-y-auto">
        <!-- Modal header -->
        <div class="top-0 bg-white dark:bg-gray-800 p-4 border-b dark:border-gray-600 z-20">
        ...
        <!-- Modal body -->
        <div class="p-4 grid grid-cols-2 gap-4 z-10">
        ...
        <!-- Modal footer -->
        <div class="bottom-0 bg-white dark:bg-gray-800 flex justify-end p-4 border-t dark:border-gray-600 z-20">
